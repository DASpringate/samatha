...
2. Blog posts can be written in .Rmd format, which is then converted to md using [knitr]() and then to html using [markdown](). Posts are then rendered within the layout for that post. 
...
##### To set up the directories for a new site:

Before you start building pages , you need to build the directory structure of your site
